...
def get_foreground_dict(ell,
    ...
    if (frequencies and external_bandpass) or (not(frequencies) and not(external_bandpass)):
        raise ValueError("You have to provide `frequencies` or `external_bandpass`")
    ...
    return ThFo.bandint_freqs, fg_dict
